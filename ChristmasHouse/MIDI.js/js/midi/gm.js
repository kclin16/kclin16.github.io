	...
	root.GM = (function(arr) {
		...
		for (var key in arr) {
			...
			for (var n = 0, length = list.length; n < length; n++) {
				...
				var num = parseInt(instrument.substring(0, instrument.indexOf(' ')), 10);
		...
		'Ensemble': ['49 String Ensemble 1', '50 String Ensemble 2', '51 SynthStrings 1', '52 SynthStrings 2', '53 Choir Aahs', '54 Voice Oohs', '55 Synth Choir', '56 Orchestra Hit'],
